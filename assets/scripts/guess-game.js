...
var wordsList = ["house", "boat", "tree", "road", "horse", "javascript", "mountain", "confusing", "brain", "apple"];
...
// Holds a mix of blank and solved letters e.g 'n, _ _, n, _'
var blanksAndSuccesses = []; //blanksAndLetters
...
// code that we will call upon to run when needed).

// startGame()
// how we will start and restart the game.
function startGame() {

  // Reset the guesses back to 0.
  numGuesses = 9;

  // word chosen randomly from wordList.
  ...
  console.log('chosenWord | in startGame(): ' + chosenWord);
  ...
  console.log('blanksAndSuccesses | in startGame(): ' + blanksAndSuccesses);
...
function checkLetters(letter) {
  ...
  if (letterInWord) {
    ...
    console.log('blanksAndSuccesses | in checkLetters(): ' + blanksAndSuccesses);
  }
...
function roundComplete() {
  ...
  console.log("in roundComplete() | WinCount: " + winCounter + " | LossCount: " + lossCounter + " | NumGuesses: " + numGuesses);
